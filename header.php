	...
	<div class="container-fluid">
		<div class="row top">
			<center>
				...
				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> bunga.florist@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>Bunga Florist World</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #b784a7"><b>BUNGA FLORIST</b></a>
			</div>
